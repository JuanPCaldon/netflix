...
export const Nowplay = () => {
  ...
  <div id='nowplay'>
    ...
    <button class={`${styles.prevbutton} + carousel-control-prev`} type="button" data-bs-target="#carousel1" data-bs-slide="prev">
      <span class="carousel-control-prev-icon" aria-hidden="true"></span>
      <span class="visually-hidden">Previous</span>
    </button>
    <button class={`${styles.nextbutton} + carousel-control-next`} type="button" data-bs-target="#carousel1" data-bs-slide="next">
